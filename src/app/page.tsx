    ...
    >
      ...
      <div id="pricing" data-section="pricing">
        <PricingCardFive
          ...
          plans={[
            { id: "cut-style", tag: "Haircut & Style", price: "From £55", period: "starting from", description: "Experience a refreshing wash, precision cut, and expert blow-dry tailored to your desired style.", button: { text: "Book Now", href: "#contact" }, featuresTitle: "Services include:", features: ["Consultation", "Wash & Condition", "Precision Cut", "Blow-Dry & Style"] },
