    ...
    >
      ...
      <div id="pricing" data-section="pricing">
        <PricingCardFive
          ...
          plans={[
            { id: "cut-style", tag: "Haircut & Style", price: "£60", period: "starting from", description: "Includes wash, cut, and professional blow-dry styling.", button: { text: "Book Now", href: "#contact" }, featuresTitle: "Services include:", features: ["Consultation", "Wash & Condition", "Precision Cut", "Blow-Dry & Style"] },
            { id: "color-highlights", tag: "Colour & Highlights", price: "£90", period: "starting from", description: "Full colour, balayage, or highlights. Price varies by length and technique.", button: { text: "Book Now", href: "#contact" }, featuresTitle: "Services include:", features: ["Consultation", "Colour Application", "Wash & Finish", "Toner (if needed)"] },
            { id: "treatments", tag: "Hair Treatments", price: "£30", period: "starting from", description: "Deep conditioning, Olaplex, and scalp treatments for healthier hair.", button: { text: "Book Now", href: "#contact" }, featuresTitle: "Treatments offer:", features: ["Deep Repair", "Added Shine", "Strength Boost", "Scalp Rejuvenation"] }
          ]}
          animationType="slide-up"
          textboxLayout="default"
          useInvertedBackground={false}
